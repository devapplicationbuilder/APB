...
public interface AuthenticationApiService {
    ...
    Mono<AuthUser> authenticateByForm(String loginId, String password, String source, boolean register, String authId, String orgId, String token, String authType);
